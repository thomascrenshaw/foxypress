        ...
        <table class="form-table">
            	...
            	<td align="center">
                    ...
                    <div class="postbox">
                    	<table>
                        	...
                        	<tr valign="top">
                                <td align="right" valign="top" nowrap>Use Lightbox</td>
                                <td align="left">
                                <?php
                                    $use_lb = get_option('foxycart_use_lightbox');
                                ?>
                                    <input type="checkbox" name="foxycart_use_lightbox" value="1" <?php echo((($use_lb == "1") ? "checked=\"checked\"" : "")) ?> /> *Foxypress will use lightbox for images rather than colorbox
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="postbox">
                    	<table>
                            ...
                            <tr valign="top">
                                ...
                                <td align="left">
                                <?php
                                    $showdbw = get_option('foxycart_show_dashboard_widget');
                                ?>
                                    <input type="checkbox" name="foxycart_show_dashboard_widget" value="1" <?php echo((($showdbw == "1") ? "checked=\"checked\"" : "")) ?> /> *Shows/Hides the FoxyPress dashboard widget
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="postbox">
                        <table>  
                            <tr>
                                <td align="right" valign="top" nowrap>Item Out Of Stock Message</td>
                                <td align="left">
            ...
            <tr>
            	<td align="center">
                    ...
                    <input type="hidden" name="page_options" value="foxycart_storeurl,foxycart_apikey,foxycart_storeversion,foxycart_include_jquery,foxycart_use_lightbox,foxypress_base_url, foxycart_enable_multiship,foxycart_show_dashboard_widget,foxypress_max_downloads,foxypress_qty_alert,foxycart_datafeeds,foxycart_currency_locale,foxypress_inactive_message,foxypress_out_of_stock_message" />
              		<p class="submit">
